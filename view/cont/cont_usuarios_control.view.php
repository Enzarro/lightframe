...
class cont_usuarios_control_view {
        ...
        <ul class="nav nav-tabs nav-underline nav-justified">
            <li class="nav-item">
                <a class="nav-link active" id="user_tab-tab1" data-toggle="tab" href="#user_tab" aria-controls="user_tab" aria-expanded="true">
                    <i class="fas fa-address-card"></i> Datos Generales
                </a>
            </li>
            <li class="nav-item">
            ...
            <?php if (isset($element['children'])): ?> 
                ...
                <?php if (!isset($element['children'])): ?>
                    ...
                    <div class="custom-control custom-switch">
                        <input type="checkbox" class="custom-control-input" id="<?=$element['id']?>" name="<?=$element['id']?>" <?=$element['activo'] ? "checked" : "" ?>>
